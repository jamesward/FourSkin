...
public class Button extends ButtonBase implements IButton
{
    ...
    public var skinStyles:Dictionary;
    ...
    public function set style(_style:String):void
    {
      ...
      try
      {
        skin['updateStylesFromStyleString']();
      }
      catch (e:Error)
      {
    ...
    override public function styleChanged(styleProp:String):void
    {
      if (skin == null)
      {
        skinStyles[styleProp] = getStyle(styleProp);
      }
      
      try
      {
        skin['styles'][styleProp] = getStyle(styleProp);
      }
      catch (e:Error)
      {
        //trace('skin styles not yet initialized');
      }
